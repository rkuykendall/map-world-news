...
/***/ function(module, exports, __webpack_require__) {
	...
	let StoryList = __webpack_require__(164)
	...
	function requestStories(slug) {
	    ...
	    $.post(url, { url: CATEGORIES[slug] }, function(data) {
	        $.post(url, { data: data }, function(data) {
	            ...
	            let i = 1;
	            log.info(data);
	            React.render(React.createElement(StoryList, {stories: data}), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	const React = __webpack_require__(8)
	const Story = __webpack_require__(165)

	module.exports = React.createClass({displayName: "module.exports",
	  render: function() {
	    return React.createElement("div", {class: "story-list"}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
	  render: function() {
	    ...
	    return React.createElement("div", {className: "story col-sm-12 col-md-4"}, 
