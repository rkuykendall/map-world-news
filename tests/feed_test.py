...
class TestFeed(unittest.TestCase):
    def test_from_feed(self):
        # # Commented out because search doesn't always have 10 things to
        # # return
        # q="flight"
        # url="http://api.feedzilla.com/v1/categories/27/articles/
        # search.atom?q="+q+"&count=10"
        url = (
            "http://api.feedzilla.com/v1/categories/16/articles.atom?count=10")
        feed = Feed(url)
